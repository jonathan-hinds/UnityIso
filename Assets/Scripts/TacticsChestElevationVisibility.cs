...
public sealed class TacticsChestElevationVisibility : MonoBehaviour
{
    [SerializeField] private IsometricMapLayerVisibilityController visibilityController;
    [SerializeField] private TacticsChestController chestController;
    ...
    private void Update()
    {
        ...
        int currentElevation = chestController.CurrentElevation;
    ...
    private void RefreshVisibility(bool force = false)
    {
        ...
        if (!force && hasAppliedVisibility && lastKnownElevation == currentElevation)
        {
            return;
        }
    ...
    {
        chestController?.SetPresentationVisible(shouldBeVisible);
    ...
    {
        chestController ??= GetComponent<TacticsChestController>();
    }
